...
func TestCheckAwsLoadBalancerController_YAML(t *testing.T) {
	// YAML 파일 "aws_load_balancer_controller.yaml"에서 테스트 케이스를 로드합니다.
	testCases := testutils.LoadTestCases(t, "aws_load_balancer_controller.yaml")
