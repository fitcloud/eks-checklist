...
// 	// YAML 파일 "aws_loadbalancer_pod_ip.yaml"에서 테스트 케이스를 로드합니다.
// 	testCases := testutils.LoadTestCases(t, "aws_loadbalancer_pod_ip.yaml")
...
// 			// fake 클라이언트셋에 기본 "kubernetes" 서비스가 있을 수 있으므로 삭제합니다.
// 			_ = client.CoreV1().Services("default").Delete(context.TODO(), "kubernetes", metav1.DeleteOptions{})
